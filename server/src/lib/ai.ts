...
import type { TrainingPlan, UserProfile } from '../../helpers/types.js';
...
const formatPlanResponse = (aiResponse: any, profile: UserProfile): Omit<TrainingPlan, "id" | "userId" | "version" | "createdAt"> => {
...
export const generateTrainingPlan = async (profile: UserProfile | Record<string, any>): Promise<Omit<TrainingPlan, "id" | "userId" | "version" | "createdAt">> => {
